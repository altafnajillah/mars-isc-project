...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
            ...
            <div class="sidebar-brand-text mx-3">ISC</div>
        </a>
        ...
        <!-- Nav Item - Input Data -->
        <li class="nav-item">
            <a class="nav-link" href="DataNilaiPeserta.html">
                <i class="fas fa-chart-line fa-2x text-gray-300"></i>
                <span>Data Nila Peserta</span>
            </a>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link" href="tableDataPeserta.html">
                <i class="fas fa-fw fa-edit"></i>
                <span>Table Data Peserta</span></a>
        </li>
                    ...
                    <div class="col-xl-3 col-md-6 mb-4">
                        <div class="card border-left-info shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Peserta
                                            yang
                                            commit hari ini
                                        </div>
                                        <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Leaderboard Bulan Ini</h6>
                                </div>
                                <div class="card-body">
                            ...
                            <div class="col">
                                ...
                                <div class="row-xl-6 row-lg-5">
                                    ...
                                    <div class="card shadow">
                                        ...
                                        <div class="card-body">
                                            <h4 class="small font-weight-bold">Komitmen Harian Peserta<span
